    ...
    <Grid container>
      <Grid item xs display="flex" flexDirection="column" zeroMinWidth gap={2}>
        ...
        <Typography style={{ wordWrap: 'break-word' }}>
          Hello I am Stan, I have been working as an engineer for seven years. Four years on front-end, three years on back-end. I have been spending my spare time discovering
