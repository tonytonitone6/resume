...
const Header = ({
  ...
  return /* @__PURE__ */ jsxs(Box$1, { display: "flex", flexDirection: "column", gap: 2, children: [
    /* @__PURE__ */ jsx(Typography$1, { variant: "h1", fontSize: "2.5rem", children: name }),
    /* @__PURE__ */ jsx(Typography$1, { variant: "h2", color: "gray", fontSize: "1.3rem", children: jobTitle }),
    /* @__PURE__ */ jsx(Typography$1, { children: "Hello I am Stan, I have been working as an engineer for six years. Three years on front-end, three years on back-end. I have been spending my spare time discovering and learning new techniques. I think It’s important to discuss with my co-workers about how to build better system architecture and use it on the official web application. Ideas sharing and team discussion play an essential part in the front-end technology. Researching the React landscape and its new trend will sure benefit our team." })
  ] });
};
const SubItem = ({ jobTitle, name, date, renderNode }) => {
  return /* @__PURE__ */ jsxs(Box$1, { marginBottom: 2, children: [
    /* @__PURE__ */ jsxs(Box$1, { display: "flex", gap: 1, alignItems: "center", children: [
      /* @__PURE__ */ jsx(Typography$1, { fontSize: "16px", fontWeight: 800, children: name }),
      "-",
      /* @__PURE__ */ jsx(Typography$1, { fontSize: "16px", fontWeight: 800, children: jobTitle })
    ] }),
    /* @__PURE__ */ jsxs(Box$1, { display: "flex", gap: 1, children: [
      /* @__PURE__ */ jsx(Typography$1, { color: "gray", fontStyle: "italic", children: date.from }),
      "-",
      /* @__PURE__ */ jsx(Typography$1, { color: "gray", fontStyle: "italic", children: date.to })
    ] }),
...
const Experience = () => {
  function renderSubItem(item) {
    ...
    function renderItem(desc) {
      return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Typography$1, { fontSize: "14px", fontWeight: 500, children: desc }, desc) }, desc);
    }
    return /* @__PURE__ */ jsx(
      SubItem,
      {
        ...rest,
        renderNode: () => /* @__PURE__ */ jsx(Box$1, { mt: 1, children: /* @__PURE__ */ jsx("ul", { children: descList.map(renderItem) }) })
      },
      item.name
    );
  }
  return /* @__PURE__ */ jsxs(Box$1, { display: "flex", flexDirection: "column", gap: 2, children: [
    /* @__PURE__ */ jsx(Typography$1, { variant: "h6", children: "WORK EXPERIENCE" }),
    experienceList.map(renderSubItem)
  ] });
};
const Education = () => {
  return /* @__PURE__ */ jsxs(Box$1, { display: "flex", flexDirection: "column", gap: 2, children: [
    /* @__PURE__ */ jsx(Typography$1, { variant: "h6", children: "EDUCATION" }),
    /* @__PURE__ */ jsxs(Box$1, { children: [
      /* @__PURE__ */ jsxs(Typography$1, { fontSize: "16px", fontWeight: 800, children: [
        "Information Management, ",
        /* @__PURE__ */ jsx("a", { target: "__blank", href: "https://new.ntpu.edu.tw/", children: "NTPU" })
      ] }),
      /* @__PURE__ */ jsx(Typography$1, { variant: "subtitle2", children: "Taiwan, Master's degree" }),
      /* @__PURE__ */ jsx(Typography$1, { color: "gray", fontStyle: "italic", variant: "subtitle2", children: "2011 - 2014" })
    ] }),
    /* @__PURE__ */ jsxs(Box$1, { children: [
      /* @__PURE__ */ jsxs(Typography$1, { fontSize: "16px", fontWeight: 800, children: [
        "Information Management, ",
      ...
      /* @__PURE__ */ jsx(Typography$1, { variant: "subtitle2", children: "Taiwan, Bachelor's degree" }),
      /* @__PURE__ */ jsx(Typography$1, { color: "gray", fontStyle: "italic", variant: "subtitle2", children: "2007 - 2011" })
    ] })
  ] });
};
const Teaching = () => {
  return /* @__PURE__ */ jsxs(Box$1, { display: "flex", flexDirection: "column", gap: 2, children: [
    /* @__PURE__ */ jsx(Typography$1, { variant: "h6", children: "TEACHING EXPERIENCE" }),
...
const Skill = ({ stacks }) => {
  return /* @__PURE__ */ jsxs(Box$1, { display: "flex", flexDirection: "column", gap: 2, children: [
    /* @__PURE__ */ jsx(Typography$1, { variant: "h6", children: "SKILLS" }),
    /* @__PURE__ */ jsx(Box$1, { width: 1, display: "flex", gap: 1.5, flexWrap: "wrap", children: /* @__PURE__ */ jsxs("ul", { children: [
...
const App = () => {
  const [profile] = reactExports.useState({
    name: "Stan Mao",
    jobTitle: "Senior Frontend Developer"
  });
  return /* @__PURE__ */ jsx(Box$1, { width: "calc(1200px - 5rem)", margin: "0 auto", pt: 5, children: /* @__PURE__ */ jsxs(Box$1, { display: "flex", flexDirection: "column", gap: 3, children: [
    /* @__PURE__ */ jsx(Header, { ...profile }),
    /* @__PURE__ */ jsxs(Box$1, { display: "flex", width: 1, alignItems: "flex-start", justifyContent: "space-between", gap: 5, children: [
      /* @__PURE__ */ jsx(Box$1, { display: "flex", justifyContent: "center", children: /* @__PURE__ */ jsx(Experience, {}) }),
      /* @__PURE__ */ jsxs(Box$1, { gap: 5, display: "flex", flexDirection: "column", justifyContent: "center", width: "350px", children: [
        /* @__PURE__ */ jsx(Skill, {}),
